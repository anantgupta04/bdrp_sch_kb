...
class ABox_Generator():
    def __init__(self):
        ...
        self.dblp_ns = rdflib.Namespace('https://dblp.org/db/')
        self.dbpedia_ns = rdflib.Namespace('http://dbpedia.org/ontology/')
        self.gkb_ns = rdflib.Namespace('http://www.semanticweb.org/gkb#')
        self.rdfs_ns = rdflib.Namespace("http://www.w3.org/2000/01/rdf-schema#")
        self.rdf_ns = rdflib.Namespace("http://www.w3.org/1999/02/22-rdf-syntax-ns#")
        self.owl_ns = rdflib.Namespace("http://www.w3.org/2002/07/owl#")

    def generate_formations_abox(self):
    
        df = pd.read_csv('Reference_data/mini_formations.csv')
    ...
    def generate_wellbores_abox(self):
    	...
    	df = pd.read_csv('Reference_data/mini_wellbores.csv')
    ...
    def save(self):
    	self.graph.serialize(destination='gkb_abox.ttl', format='turtle')
    	print('saved')
